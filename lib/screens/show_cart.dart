...
class _ShowCartState extends State<ShowCart> {
  ...
  Future notificationToShop(String idShop) async{
    String urlFindToken ='${MyConstant().domain}/rabbitfood/getUserWhereId.php?isAdd=true&id=$idShop';
    ...
    await Dio().get(urlFindToken).then((value) {
      ...
      for (var json in result) {
        ...
        String tokenShop = model.token.toString();
  ...
  Future sendNOtificationToShop(String urlSemdToken) async{
    await Dio().get(urlSemdToken).then((value) {
      normalDialog(context, 'ส่งออเดอร์ไปยังร้านค้าเรียบร้อย');
    });
  }
}
